...
namespace API.Controllers
{
    public class PersonaController : ApiController
    {
        ...
        public object persona_insertar(Persona _objPersona)
        {
            ...
            //        var _objTipoIdentificacion = _objCatalogoTipoIdentificacion.ConsultarTipoIdentificacion().Where(c => c.IdTipoIdentificacionEncriptado == _idSexoDesencriptado && c.Estado == true).FirstOrDefault();
