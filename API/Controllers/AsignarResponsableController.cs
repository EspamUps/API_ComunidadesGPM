        ...
        public object asignarresponsable_insertar(AsignarResponsable _objAsignarResponsable)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var _objCuestionarioGenerico = _objCatalogoCuestionarioGenerico.ConsultarCuestionarioGenerico().Where(c => c.IdCuestionarioGenerico == _idCuestionarioGenerico && c.Estado == true).FirstOrDefault();
