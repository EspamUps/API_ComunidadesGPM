...
namespace API.Controllers
{
    public class AsignarModeloGenericoParroquiaController : ApiController
    {
        ...
        [HttpPost]
        [Route("api/HabilitarModeloGenericoParroquia")]
        public object HabilitarModeloGenericoParroquia(AsignarModeloGenericoParroquia _AsignarModeloGenericoParroquia)
        {
            object _respuesta = new object();
            RespuestaHTTP _http = _objCatalogoRespuestasHTTP.consultar().Where(x => x.codigo == "500").FirstOrDefault();
            try
            {
                ...
                {
                    var _dataModeloGenericoParroquia = _objAsignarModeloGenericoParroquia.ConsultarAsignarModeloGenericoParroquiaPorId(int.Parse(_seguridad.DesEncriptar(_AsignarModeloGenericoParroquia.IdAsignarModeloGenericoParroquiaEncriptado))).FirstOrDefault();
                    ...
                    {
                        _objAsignarModeloGenericoParroquia.HabilitarModeloGenericoParroquia(int.Parse(_seguridad.DesEncriptar(_AsignarModeloGenericoParroquia.IdAsignarModeloGenericoParroquiaEncriptado)));
                        _http = _objCatalogoRespuestasHTTP.consultar().Where(x => x.codigo == "200").FirstOrDefault();
                    }
                }
            }
        ...
        [HttpPost]
        [Route("api/DesHabilitarModeloGenericoParroquia")]
        public object DesHabilitarModeloGenericoParroquia(AsignarModeloGenericoParroquia _AsignarModeloGenericoParroquia)
        {
            object _respuesta = new object();
            RespuestaHTTP _http = _objCatalogoRespuestasHTTP.consultar().Where(x => x.codigo == "500").FirstOrDefault();
            try
            {
                ...
                else
                {
                    ...
                    {
                        _objAsignarModeloGenericoParroquia.DesHabilitarModeloGenericoParroquia(int.Parse(_seguridad.DesEncriptar(_AsignarModeloGenericoParroquia.IdAsignarModeloGenericoParroquiaEncriptado)));
                        _http = _objCatalogoRespuestasHTTP.consultar().Where(x => x.codigo == "200").FirstOrDefault();
                    }
                }
            }
