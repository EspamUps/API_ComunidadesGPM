...
namespace API.Models.Catalogos
{
    public class CatalogoAsignarResponsableModeloPublicado
    {
        ...
        public int InsertarAsignarResponsableModeloPublicado(AsignarResponsableModeloPublicado _objAsignar)
        {
            try
            {
                return int.Parse(db.Sp_AsignarResponsableModeloPublicadoInsertar(_objAsignar.PresidenteJuntaParroquial.IdPresidenteJuntaParroquial,_objAsignar.FechaAsignacion,_objAsignar.AsignarUsuarioTipoUsuario.IdAsignarUsuarioTipoUsuario,_objAsignar.ModeloPublicado.IdModeloPublicado,_objAsignar.FechaIncio,_objAsignar.FechaFin,_objAsignar.Estado).Select(x=>x.Value.ToString()).FirstOrDefault());
            }
            catch (Exception)
            {
                return 0;
        ...
        public int ModificarAsignarResponsableModeloPublicado(AsignarResponsableModeloPublicado _objAsignar)
        {
            try
            {
               db.Sp_AsignarResponsableModeloPublicadoModificar(_objAsignar.IdAsignarResponsableModeloPublicado,_objAsignar.PresidenteJuntaParroquial.IdPresidenteJuntaParroquial, _objAsignar.FechaAsignacion, _objAsignar.AsignarUsuarioTipoUsuario.IdAsignarUsuarioTipoUsuario, _objAsignar.ModeloPublicado.IdModeloPublicado, _objAsignar.FechaIncio, _objAsignar.FechaFin, _objAsignar.Estado);
