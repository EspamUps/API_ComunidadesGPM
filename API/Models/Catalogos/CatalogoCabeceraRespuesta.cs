...
{
    public class CatalogoCabeceraRespuesta
    {
        ...
        public List<CabeceraRespuesta> ConsultarCabeceraRespuestaPorIdAsignarEncuestado(int _idAsignarEncuestado)
        {
            List<CabeceraRespuesta> _lista = new List<CabeceraRespuesta>();
            foreach (var item in db.Sp_CabeceraRespuestaConsultarPorAsignarEncuestado(_idAsignarEncuestado))
            {
                _lista.Add(new CabeceraRespuesta()
                {
                    ...
                    Utilizado=item.utilizadoCabeceraRespuesta,
        ...
        public List<CabeceraRespuesta> ConsultarCabeceraRespuestaPorId(int _idCabeceraRespuesta)
        {
            List<CabeceraRespuesta> _lista = new List<CabeceraRespuesta>();
            foreach (var item in db.Sp_CabeceraRespuestaConsultarPorId(_idCabeceraRespuesta))
            {
                _lista.Add(new CabeceraRespuesta()
                {
                    IdCabeceraRespuesta = item.IdCabeceraRespuesta,
