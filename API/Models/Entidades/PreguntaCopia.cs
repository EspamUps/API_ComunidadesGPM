...
namespace API.Models.Entidades
{
    public class PreguntaCopia
    {
        ...
        public List<ConfigurarMatrizCopia> ConfiguracionMatrizCopia { get; set; }
        public List<OpcionPreguntaSeleccionCopia> OpcionPreguntaSeleccionCopia { get; set; }
    }
}