...
namespace API.Conexion
{
    ...
    public partial class ComunidadesGPMEntities : DbContext
    {
        ...
        public virtual ObjectResult<Sp_ListadoPreguntasPorComponente_Result5> Sp_ListadoPreguntasPorComponente(Nullable<int> idComponente, Nullable<int> idUsuarioTecnico)
        {
            var idComponenteParameter = idComponente.HasValue ?
                new ObjectParameter("idComponente", idComponente) :
                new ObjectParameter("idComponente", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Sp_ListadoPreguntasPorComponente_Result5>("Sp_ListadoPreguntasPorComponente", idComponenteParameter, idUsuarioTecnicoParameter);
        }
        ...
        public virtual ObjectResult<Sp_ComponenteConsultarPorVersion_Result1> Sp_ComponenteConsultarPorVersion(Nullable<int> idVersion)
        {
            var idVersionParameter = idVersion.HasValue ?
                new ObjectParameter("idVersion", idVersion) :
                new ObjectParameter("idVersion", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Sp_ComponenteConsultarPorVersion_Result1>("Sp_ComponenteConsultarPorVersion", idVersionParameter);
        }
    
        public virtual ObjectResult<Sp_SeccionConsultarPorVersion_Result1> Sp_SeccionConsultarPorVersion(Nullable<int> idVersion)
        {
            var idVersionParameter = idVersion.HasValue ?
                new ObjectParameter("idVersion", idVersion) :
                new ObjectParameter("idVersion", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Sp_SeccionConsultarPorVersion_Result1>("Sp_SeccionConsultarPorVersion", idVersionParameter);
        }
    
        public virtual ObjectResult<Sp_PreguntaConsultarNoEncajonadasPorSeccionPorVersion_Result2> Sp_PreguntaConsultarNoEncajonadasPorSeccionPorVersion(Nullable<int> idSeccion, Nullable<int> idVersion)
        {
            var idSeccionParameter = idSeccion.HasValue ?
                new ObjectParameter("IdSeccion", idSeccion) :
                new ObjectParameter("IdSeccion", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Sp_PreguntaConsultarNoEncajonadasPorSeccionPorVersion_Result2>("Sp_PreguntaConsultarNoEncajonadasPorSeccionPorVersion", idSeccionParameter, idVersionParameter);
        }
    }
}
