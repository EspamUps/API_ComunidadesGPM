...
namespace API.Conexion
{
    ...
    public partial class Sp_CabeceraVersionModeloConsultar_Result
    {
        ...
        public string UtilizadoCabeceraVersionModelo { get; set; }
        public int MODELOGENERICO_IdModeloGenerico { get; set; }
        public string MODELOGENERICO_Descripcion { get; set; }
        public string MODELOGENERICO_Nombre { get; set; }
        public bool MODELOGENERICO_Estado { get; set; }
